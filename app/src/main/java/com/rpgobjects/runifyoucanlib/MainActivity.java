package com.rpgobjects.runifyoucanlib;
...
import com.rpgobjects.runifyoucan.RunIfYouCan;

public class MainActivity extends AppCompatActivity {

    RunIfYouCan runIfYouCan = new RunIfYouCan();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        runIfYouCan.onRequestPermissionsResult(requestCode, permissions, grantResults);
    }
